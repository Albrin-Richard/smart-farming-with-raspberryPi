...
public class plant2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pumpTomato = (TextView) findViewById(R.id.pump2State);

        //To get link from previous page
        Intent intentPlant2 = getIntent();
        link = intentPlant2.getStringExtra("link");

        if(intentPlant2 !=null) {
            linkValue = link+"tomato";
            System.out.println(linkValue);
            linkPump = link +"tomato_pump";
        }
        ...
        button.setOnClickListener(v -> {
            ...
            if (pumpState == 0){
                pumpTomato.setText("ON");
                pumpTomato.setBackgroundColor(Color.GREEN);
                pumpState = 1;
                button.setText("STOP PUMP");
            }else if(pumpState == 1){
                pumpTomato.setText("OFF");
                pumpTomato.setBackgroundColor(Color.RED);
                pumpState = 0;
            ...
            Log.i(LOG_CLICK, "--->Tomato Pump Button Click");
    ...
    protected void setGraphValues(String jsonString) throws JSONException {
        ...
        JSONObject jsonobject = jsonObject.getJSONObject("tomato");

        //Set Pump Value and Background color
        if (jsonObject.getInt("pump_tomato") == 1){
            pumpTomato.setText("ON");
            pumpTomato.setBackgroundColor(Color.GREEN);
            pumpState = 1;
        }else {
        ...
        series.setColor(Color.rgb(255,50,50)); //set Color
        series.setTitle("Tomato"); // set Title
        ...
        public  void run(){
            ...
            mainHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    progressDialog = new ProgressDialog(plant2.this);
            ...
            try {
                ...
                if(!jsonData.isEmpty()){
                    ...
                    //jsonString = data;
                    Log.i(LOG_CLICK, "--->data got plant2");
